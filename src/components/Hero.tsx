  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6 text-center animate-fade-in-up">
        ...
        <p className="text-lg md:text-xl lg:text-2xl mb-4 text-foreground/90 max-w-3xl mx-auto leading-relaxed">
        ...
        <p className="text-base md:text-lg mb-6 text-foreground/70 max-w-2xl mx-auto">
          No beacons, no confusion—just seamless indoor experiences that work offline.
        </p>
        
        {/* Checklist */}
        <div className="flex flex-wrap justify-center gap-4 md:gap-8 mb-6 text-sm md:text-base text-foreground/80">
        ...
        {/* No beacons pill */}
        <div className="mb-8">
          <span className="inline-block bg-primary/10 border border-primary/30 text-primary px-4 py-2 rounded-full text-sm backdrop-blur-sm">
            No beacons required
          </span>
        </div>
