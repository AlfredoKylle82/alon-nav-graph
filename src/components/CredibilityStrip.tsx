  ...
  return (
    <section className="bg-white/5 backdrop-blur-sm border-y border-white/10 py-6 animate-fade-in">
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="flex flex-row flex-wrap items-center justify-center gap-3 sm:gap-6 md:gap-8 lg:gap-16 text-foreground">
          <div className="flex items-center gap-2 text-xs sm:text-sm md:text-base hover:text-foreground/80 transition-colors duration-300">
